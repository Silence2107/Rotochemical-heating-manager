...
- `"DensityProvidedAs"` (string, required) **:** The way the "CenterDensity" and "DensityStep" are provided. Choose from ["Same", "LinspacedMinToMax"]. "LinspacedMinToMax" linearly maps $[0,1] -> [\rho_{min}, \rho_{max}]$, while "Same" assumes same units as for "EnergyDensity".
