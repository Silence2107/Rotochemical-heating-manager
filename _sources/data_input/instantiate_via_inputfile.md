...
An example of such predefined instantiator is provided under <span style="color:blue">_inputfile/instantiator.hpp_</span>, and an example of inputfile lies under <span style="color:blue">_presupplied/Inputfile/RHMconfig.json_</span>.
