...
Make is used to compile any program that uses RHM library. Example in [Getting Started](first_run.md) is rather generic and, in general, executes as follows
```bash
