...
```
- `"EoSInterpolation"` (string, [<span style="color:red">TOV, COOL, RH</span>]) **:** Interpolation kind to be used for discretized $\rho(P)$ dependence. Choose from ["Linear", "Cubic"], with "Cubic" being default. 
